<template>
    <div class="mine">
       ...
       <div class="btn">
        ...
        <p class="per_for">
            表达方式——说明：说明是用简明扼要的文字，把事物的形状、性质、特征、成因、关系、
            功用等解说清楚的表达方式。这种被解说的对象，有的是实体的事物，如山川、江河、
            花草、树木、建筑、器物等；有的是抽象的道理，如思想、意识、修养、观点、概念、原理、技术等。
        </p>
        <button @click="goMore()">开始答题</button>
       </div>
